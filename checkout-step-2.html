...
<head>
  ...
  <title>Checkout Step 2 - KIDZ</title>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="active dropdown singleDrop color-4">
                <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                  ...
                  <li class="active dropdown dropdown-submenu">
                    ...
                    <ul class="dropdown-menu">
                      <li><a href="checkout-step-1.html">Personal Info</a></li>
                      <li class="active"><a href="checkout-step-2.html">Payment Info</a></li>
                      <li><a href="checkout-step-3.html">Confirmation</a></li>
                    </ul>
                  </li>
                </ul>
      ...
      <div class="container">
        <div class="pageTitleInfo">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Checkout Step 2</li>
          </ol>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-sm-4 col-sm-push-8 col-xs-12">
            <div class="pricingTable">
              <div class="priceUper">
                <div class="priceTitle alt bg-color-3 checkingTitle"><h3>Morning Session</h3></div>
                <div class="priceInfo alt p-n bg-color-3"><img src="img/home/news/news-1.jpg" class="img-responsive"></div>
              </div>
          ...
          <div class="col-sm-8  col-sm-pull-4 col-xs-12">
            <form action="#" method="POST" role="form" class="form">
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group">
                    <div class="col-sm-6 col-xs-12">
                      ...
                      <input type="text" class="form-control border-color-2" id="">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-6 col-xs-12">
                  ...
                  <div class="form-group">
                    <div class="col-sm-6 col-xs-12">
                      ...
                      <input type="text" class="form-control border-color-4" id="">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-6 col-xs-12">
                      <label for="">City</label>
                      <input type="text" class="form-control border-color-5" id="">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-6 col-xs-12">
                      <label for="">Zip Code</label>
                      <input type="text" class="form-control border-color-6" id="">
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-6 col-xs-12">
                  ...
                  <div class="row card-img">
                    <div class="col-sm-6 col-xs-12">
                      ...
                      <ul class="list-inline">
                        <li><a href="#"><img src="img/checkout/master-card.png" alt="image"></a></li>
                        <li><a href="#"><img src="img/checkout/discover.png" alt="image"></a></li>
                        <li><a href="#"><img src="img/checkout/visa.png" alt="image"></a></li>
                        <li><a href="#"><img src="img/checkout/paypal.png" alt="image"></a></li>
                      </ul>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-6 col-xs-12">
                      ...
                      <div class="bookingDrop alt">
                        <select name="guiest_id4" id="guiest_id4" class="select-drop">
                          ...
                          <option value="1">Expiration Date 1</option>
                          <option value="2">Expiration Date 2</option>
                          <option value="3">Expiration Date 3</option>            
                        </select>
                      </div>
                    </div>
                  </div>
              ...
              <div class="continueBtnArea">
                <ul class="list-inline">
                  <li><a href="checkout-step-2.html" class="btn btn-primary">back</a></li>
                  <li class="pull-right"><a href="checkout-step-3.html" class="btn btn-primary">next</a></li>
                </ul>
              </div>
            </form>
          </div>
