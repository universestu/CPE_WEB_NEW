...
<head>
  ...
  <title>Checkout Step 1 - KIDZ</title>
              ...
              <li class="active dropdown singleDrop color-4">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                  ...
                  <li class="active dropdown dropdown-submenu">
                    ...
                    <ul class="dropdown-menu">
                      <li class="active"><a href="checkout-step-1.html">Personal Info</a></li>
                      <li><a href="checkout-step-2.html">Payment Info</a></li>
                      <li><a href="checkout-step-3.html">Confirmation</a></li>
                    </ul>
                  </li>
            ...
            <form action="#" method="POST" role="form" class="form">
              ...
              <div class="continueBtnArea">
                <ul class="list-inline">
                  ...
                  <li class="pull-right"><a href="checkout-step-2.html" class="btn btn-primary">next</a></li>
                </ul>
              </div>
            </form>
          </div>
