              ...
              <li class="active dropdown singleDrop color-3">
                ...
                <ul class="dropdown-menu dropdown-menu-left">
                  ...
                  <li class="active dropdown dropdown-submenu">
                    ...
                    <ul class="dropdown-menu">
                      <li class="active"><a href="all-events.html">All Events</a></li>
        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-xs-12 block">
            <div class="media eventContent bg-color-5">
              ...
              <div class="media-body">
                <h3 class="media-heading"><a href="single-event-left-sidebar.html">Praesent quis felis non.</a></h3>
                <ul class="list-unstyled">
                  <li><i class="fa fa-calendar-o" aria-hidden="true"></i>Age 2 to 4 Years</li>
                  <li><i class="fa fa-clock-o" aria-hidden="true"></i>9.00AM-11.00AM</li>
                </ul>
          ...
          <div class="col-sm-6 col-xs-12 block">
            <div class="media eventContent bg-color-6">
              ...
              <div class="media-body">
                <h3 class="media-heading"><a href="single-event-left-sidebar.html">Fusce feugiat diam ac metus.</a></h3>
                <ul class="list-unstyled">
                  <li><i class="fa fa-calendar-o" aria-hidden="true"></i>Age 2 to 4 Years</li>
                  <li><i class="fa fa-clock-o" aria-hidden="true"></i>9.00AM-11.00AM</li>
                </ul>
