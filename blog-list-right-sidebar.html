...
<head>
  ...
  <title>Blog List Right Sidebar - KIDZ</title>
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                  ...
                  <li class="active dropdown dropdown-submenu">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="active"><a href="blog-list-right-sidebar.html">Blog List Right Sidebar</a></li>
                    </ul>
                  </li>
                  <li class="dropdown dropdown-submenu">
          ...
          <div class="col-md-9 col-sm-8 col-xs-12">
            <div class="media courseList">
              <a class="media-left" href="single-blog-left-sidebar.html">
                ...
                <span class="sticker-round bg-color-1">10 <br>July</span>
              </a>
              <div class="media-body">
                <h3 class="media-heading"><a href="single-blog-left-sidebar.html" class="color-1">Phasellus convallis eros.</a></h3>
            ...
            <div class="media courseList">
              <a class="media-left" href="single-blog-left-sidebar.html">
                ...
                <span class="sticker-round bg-color-2">10 <br>July</span>
              </a>
              <div class="media-body">
                <h3 class="media-heading"><a href="single-blog-left-sidebar.html" class="color-2">Phasellus convallis eros.</a></h3>
                <ul class="list-inline">
                  <li><i class="fa fa-user" aria-hidden="true"></i>Jone Doe</li>
                  <li><i class="fa fa-comments-o" aria-hidden="true"></i>4 Comments </li>
                </ul>
            ...
            <div class="media courseList">
              <a class="media-left" href="single-blog-left-sidebar.html">
                ...
                <span class="sticker-round bg-color-3">10 <br>July</span>
              </a>
              <div class="media-body">
                <h3 class="media-heading"><a href="single-blog-left-sidebar.html" class="color-3">Phasellus convallis eros.</a></h3>
                <ul class="list-inline">
                  <li><i class="fa fa-user" aria-hidden="true"></i>Jone Doe</li>
                  <li><i class="fa fa-comments-o" aria-hidden="true"></i>4 Comments </li>
                </ul>
            ...
            <div class="media courseList">
              <a class="media-left" href="single-blog-left-sidebar.html">
                ...
                <span class="sticker-round bg-color-4">10 <br>July</span>
              </a>
              <div class="media-body">
                <h3 class="media-heading"><a href="single-blog-left-sidebar.html" class="color-4">Phasellus convallis eros.</a></h3>
                <ul class="list-inline">
                  <li><i class="fa fa-user" aria-hidden="true"></i>Jone Doe</li>
                  <li><i class="fa fa-comments-o" aria-hidden="true"></i>4 Comments </li>
                </ul>
            ...
            <div class="media courseList">
              <a class="media-left" href="single-blog-left-sidebar.html">
                <img class="media-object" src="img/home/courses/course-1.jpg" alt="Image">
                <span class="sticker-round bg-color-5">10 <br>July</span>
              </a>
              <div class="media-body">
                <h3 class="media-heading"><a href="single-blog-left-sidebar.html" class="color-5">Phasellus convallis eros.</a></h3>
                <ul class="list-inline">
                  <li><i class="fa fa-user" aria-hidden="true"></i>Jone Doe</li>
                  <li><i class="fa fa-comments-o" aria-hidden="true"></i>4 Comments </li>
                </ul>
            ...
            <div class="media courseList">
              <a class="media-left" href="single-blog-left-sidebar.html">
                <img class="media-object" src="img/home/courses/course-2.jpg" alt="Image">
                <span class="sticker-round bg-color-6">10 <br>July</span>
              </a>
              <div class="media-body">
                <h3 class="media-heading"><a href="single-blog-left-sidebar.html" class="color-6">Phasellus convallis eros.</a></h3>
                <ul class="list-inline">
                  <li><i class="fa fa-user" aria-hidden="true"></i>Jone Doe</li>
                  <li><i class="fa fa-comments-o" aria-hidden="true"></i>4 Comments </li>
                </ul>
