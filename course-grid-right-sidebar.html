...
<head>
  ...
  <title>Course Grid Right Sidebar - KIDZ SCHOOL</title>
                ...
                <ul class="row dropdown-menu">
                  <li class="col-sm-3 col-xs-12">
                    <ul class="list-unstyled">
                      ...
                      <li class="active"><a href="course-grid-right-sidebar.html">Courses Grid Right Sidebar</a></li>
                    </ul>
                  </li>
                  <li class="col-sm-3 col-xs-12">
                    <ul class="list-unstyled">
          ...
          <div class="col-md-9 col-sm-7 col-xs-12">
            <div class="row">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 block">
                <div class="thumbnail thumbnailContent">
                  <a href="course-single-left-sidebar.html"><img src="img/home/courses/course-3.jpg" alt="image" class="img-responsive"></a>
                  <div class="sticker bg-color-5">$50</div>
                  <div class="caption border-color-5">
                    <h3><a href="course-single-left-sidebar.html" class="color-5">Suspendisse a libero da.</a></h3>
                    <ul class="list-unstyled">
                      <li><i class="fa fa-calendar-o" aria-hidden="true"></i>Age 2 to 4 Years</li>
                      <li><i class="fa fa-clock-o" aria-hidden="true"></i>9.00AM-11.00AM</li>
                    </ul>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 block">
                <div class="thumbnail thumbnailContent">
                  <a href="course-single-left-sidebar.html"><img src="img/home/courses/course-4.jpg" alt="image" class="img-responsive"></a>
                  <div class="sticker bg-color-6">$50</div>
                  <div class="caption border-color-6">
                    <h3><a href="course-single-left-sidebar.html" class="color-6">Aenean cursus urna nec.</a></h3>
                    <ul class="list-unstyled">
                      <li><i class="fa fa-calendar-o" aria-hidden="true"></i>Age 2 to 4 Years</li>
                      <li><i class="fa fa-clock-o" aria-hidden="true"></i>9.00AM-11.00AM</li>
                    </ul>
