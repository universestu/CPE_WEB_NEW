...
<head>
  ...
  <title>Products Right Sidebar - KIDZ STORE</title>
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                  <li class="active dropdown dropdown-submenu">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="active"><a href="product-right-sidebar.html">Products Right Sidebar</a></li>
                    </ul>
                  </li>
              ...
              <div class="panel panel-default courseSidebar">
                ...
                <div class="panel-body">
                  <ul class="list-unstyled categoryItem">
                    ...
                    <li><a href="category.html">Foot Wear</a></li>
                    <li><a href="category.html">Inner Wear</a></li>
                    <li><a href="category.html">Night Wear</a></li>
