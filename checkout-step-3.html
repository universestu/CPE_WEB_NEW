...
<head>
  ...
  <title>Checkout Step 3 - KIDZ</title>
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                  ...
                  <li class="active dropdown dropdown-submenu">
                    ...
                    <ul class="dropdown-menu">
                      <li><a href="checkout-step-1.html">Personal Info</a></li>
                      <li><a href="checkout-step-2.html">Payment Info</a></li>
                      <li class="active"><a href="checkout-step-3.html">Confirmation</a></li>
                    </ul>
                  </li>
                </ul>
              </li>
      ...
      <div class="container">
        <div class="pageTitleInfo">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Checkout Step 3</li>
          </ol>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          ...
          <div class="col-xs-12">
            <div class="lowerPartTitle">
              ...
              <h4>Your Payment id: <span>#23154632125</span></h4>
            </div>
          </div>
          <div class="col-sm-6 col-xs-12">
            <dl class="dl-horizontal addressInfo">
              <dt>Address:</dt>
              <dd>Refat Newaz Abir <br>Shyamoli, Ring Road, <br>7/4/c Garden Street, <br>Dhaka</dd>
            </dl>
          </div>
          <div class="col-sm-6 col-xs-12">
            <div class="priceBtn text-right">
