...
<head>
  ...
  <title>Blog Grid Right Sidebar - KIDZ</title>
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                  <li class="active dropdown dropdown-submenu">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li class="active"><a href="blog-grid-right-sidebar.html">Blog Grid Right Sidebar</a></li>
                    </ul>
                  </li>
                  <li class="dropdown dropdown-submenu">
            ...
            <div class="row">
              <div class="col-md-4 col-sm-6 col-xs-12 block">
                <div class="thumbnail thumbnailContent">
                  <a href="single-blog-left-sidebar.html"><img src="img/home/courses/course-1.jpg" alt="image" class="img-responsive"></a>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 block">
                <div class="thumbnail thumbnailContent">
                  <a href="single-blog-left-sidebar.html"><img src="img/home/courses/course-2.jpg" alt="image" class="img-responsive"></a>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 block">
                <div class="thumbnail thumbnailContent">
                  <a href="single-blog-left-sidebar.html"><img src="img/home/courses/course-3.jpg" alt="image" class="img-responsive"></a>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 block">
                <div class="thumbnail thumbnailContent">
                  <a href="single-blog-left-sidebar.html"><img src="img/home/courses/course-4.jpg" alt="image" class="img-responsive"></a>
                  <div class="sticker-round bg-color-4">10 <br>July</div>
                  <div class="caption border-color-4">
                    <h3><a href="single-blog-left-sidebar.html" class="color-4">The standard chunk of Lorem.</a></h3>
                    <ul class="list-inline">
                      <li><i class="fa fa-user" aria-hidden="true"></i>Jone Doe</li>
                      <li><i class="fa fa-comments-o" aria-hidden="true"></i>4 Comments </li>
                    </ul>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 block">
                <div class="thumbnail thumbnailContent">
                  ...
                  <div class="caption border-color-5">
                    <h3><a href="single-blog-left-sidebar.html" class="color-5">Vestibulum congue massa vitae.</a></h3>
                    <ul class="list-inline">
                      <li><i class="fa fa-user" aria-hidden="true"></i>Jone Doe</li>
                      <li><i class="fa fa-comments-o" aria-hidden="true"></i>4 Comments </li>
                    </ul>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 block">
                <div class="thumbnail thumbnailContent">
                  <a href="single-blog-left-sidebar.html"><img src="img/home/courses/course-4.jpg" alt="image" class="img-responsive"></a>
                  <div class="sticker-round bg-color-6">10 <br>July</div>
                  <div class="caption border-color-6">
                    <h3><a href="single-blog-left-sidebar.html" class="color-6">Curabitur ac nulla sodales risus.</a></h3>
                    <ul class="list-inline">
                      <li><i class="fa fa-user" aria-hidden="true"></i>Jone Doe</li>
                      <li><i class="fa fa-comments-o" aria-hidden="true"></i>4 Comments </li>
                    </ul>
