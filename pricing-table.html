...
<head>
  ...
  <title>Pricing Table - KIDZ</title>
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="active dropdown singleDrop color-3">
                ...
                <ul class="dropdown-menu dropdown-menu-left">
                  ...
                  <li class="active"><a href="pricing-table.html">Pricing Table</a></li>
        ...
        <div class="row">
          <div class="col-lg-3 col-sm-6 col-xs-12">
            <div class="pricingTable">
              <div class="priceUper">
                <div class="priceTitle bg-color-1"><h3>Morning Session</h3></div>
                <div class="priceInfo bg-color-1"><p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots.</p></div>
              </div>
          ...
          <div class="col-lg-3 col-sm-6 col-xs-12">
            <div class="pricingTable">
              <div class="priceUper">
                ...
                <div class="priceInfo bg-color-2"><p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots.</p></div>
              </div>
              <div class="priceLower">
                <ul class="list-unstyled priceOffer">
          ...
          <div class="col-lg-3 col-sm-6 col-xs-12">
            <div class="pricingTable">
              <div class="priceUper">
                ...
                <div class="priceInfo bg-color-3"><p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots.</p></div>
              </div>
              <div class="priceLower">
                <ul class="list-unstyled priceOffer">
          ...
          <div class="col-lg-3 col-sm-6 col-xs-12">
            <div class="pricingTable">
              <div class="priceUper">
                ...
                <div class="priceInfo bg-color-4"><p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots.</p></div>
              </div>
              <div class="priceLower">
                <ul class="list-unstyled priceOffer">
                  <li><i class="fa fa-birthday-cake color-4" aria-hidden="true"></i> 2 Meals/Day</li>
                  <li><i class="fa fa-medkit color-4" aria-hidden="true"></i> Medical Assistance</li>
                  <li><i class="fa fa-paint-brush color-4" aria-hidden="true"></i> Drowing &amp; Dancing</li>
                  <li><i class="fa fa-taxi color-4" aria-hidden="true"></i> Free Transport</li>
                </ul>
                <div class="priceBtn">
                  <a href="checkout-step-1.html" class="btn btn-primary bg-color-4">Choose Plan</a>
                  <h4 class="color-4">$69 <br><small>Per Month</small></h4>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-6 col-xs-12">
            <div class="pricingTable tableVertical">
              <div class="priceUper">
                <div class="priceTitle bg-color-1"><h3>Morning Session</h3></div>
                <div class="priceInfo bg-color-1">
                  <p>Contrary to popular belief, Lorem Ipsum is not simply random.</p>
                  <div class="priceBtn alt">
                    <a href="checkout-step-1.html" class="btn btn-primary">Choose Plan</a>
                    <h4>$69 <br><small>Per Month</small></h4>
                  </div>
                </div>
              </div>
              <div class="priceLower">
