...
<head>
  ...
  <title>Single Product - KIDZ STORE</title>
          ...
          <div class="col-md-6 col-sm-7 col-xs-12">
            <div class="product-gallery">
              <div class="product-gallery-content">
                <ul class="product-gallery-preview">
                  <li id="preview01" class="current">
                    <img src="img/single-product/image-1.png" alt="Product" class="img-responsive">
                  </li>
                  <li id="preview02">
                    <img src="img/single-product/image-2.png" alt="Product" class="img-responsive">
                  </li>
                  <li id="preview03">
                    <img src="img/single-product/image-3.png" alt="Product" class="img-responsive">
                  </li>
                </ul>
              </div>
              ...
              <ul class="product-gallery-thumblist">
                <li class="active">
                  <a href="#preview01">
                  <img src="img/single-product/thumb01.jpg" alt="Product" class="img-responsive">
                  </a>
                </li>
                <li class="">
                  <a href="#preview02">
                  <img src="img/single-product/thumb02.jpg" alt="Product" class="img-responsive">
                  </a>
                </li>
                <li class="">
                  <a href="#preview03">
                  <img src="img/single-product/thumb03.jpg" alt="Product" class="img-responsive">
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div class="product-info">
              ...
              <div class="product-meta">
                <div class="product-category">
                  ...
                  <a href="category.html">Colorfull</a>
                </div>
              </div>
              <div class="share">
                <span>Share: </span>
      ...
      <div class="container">
        ...
        <div class="tabCommon">
          <ul class="nav nav-tabs">
            ...
            <li><a data-toggle="tab" href="#menu2">Review(2)</a></li>
          </ul>
          ...
          <div class="tab-content">
            <div id="menu1" class="tab-pane fade in active">
              <div class="media">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspici
atis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam</p>
                <ul class="list-unstyled para-list">
                  ...
                  <li><i class="fa fa-check" aria-hidden="true"></i>Iaculis quam ac libero.</li>
                </ul>
                <ul class="list-unstyled para-list">
                  <li><i class="fa fa-check" aria-hidden="true"></i>Vestibulum iaculis quam.</li>
                  <li><i class="fa fa-check" aria-hidden="true"></i>Quam ac libero volutpat placerat.</li>
            ...
            <div id="menu2" class="tab-pane fade">
              <ul class="media-list commentsList">
                <li class="media">
                  ...
                  <div class="media-body">
                    <h4 class="media-heading">Nice design, afordable price</h4>
