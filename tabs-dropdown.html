          ...
          <div class="col-xs-12">
            <div class="tabCommon">
              <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#home">View All</a></li>
                <li><a data-toggle="tab" href="#menu1">Charity</a></li>
                <li><a data-toggle="tab" href="#menu2">nature</a></li>
                <li><a data-toggle="tab" href="#menu3">Children</a></li>
              </ul>
        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="tabCommon tabLeft">
              <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#leftHome">View All</a></li>
                <li><a data-toggle="tab" href="#leftMenu1">Charity</a></li>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-3 col-xs-12">
            <div class="dropGeneral colorBg bg-color-3">
              <select name="guiest_id13" id="guiest_id13" class="select-drop">
                <option value="0">Dropdown 1</option>
                <option value="1">Dropdown 1a</option>
                <option value="2">Dropdown 1b</option>
                <option value="3">Dropdown 1c</option>            
              </select>
            </div>
            <div class="dropGeneral grayBg">
              <select name="guiest_id12" id="guiest_id12" class="select-drop">
                <option value="0">Dropdown 1</option>
                <option value="1">Dropdown 1a</option>
                <option value="2">Dropdown 1b</option>
                <option value="3">Dropdown 1c</option>            
            ...
            <div class="dropGeneral border-color-3">
              <select name="guiest_id11" id="guiest_id11" class="select-drop">
                <option value="0">Dropdown 1</option>
                <option value="1">Dropdown 1a</option>
                <option value="2">Dropdown 1b</option>
                <option value="3">Dropdown 1c</option>            
            ...
            <div class="dropGeneral">
              <select name="guiest_id10" id="guiest_id10" class="select-drop">
                <option value="0">Dropdown 1</option>
                <option value="1">Dropdown 1a</option>
                <option value="2">Dropdown 1b</option>
                <option value="3">Dropdown 1c</option>            
          ...
          <div class="col-sm-3 col-xs-12">
            <div class="dropGeneral roundOne colorBg bg-color-2">
              <select name="guiest_id14" id="guiest_id14" class="select-drop">
                <option value="0">Dropdown 2</option>
                <option value="1">Dropdown 2a</option>
                <option value="2">Dropdown 2b</option>
                <option value="3">Dropdown 2c</option>            
              </select>
            </div>
            <div class="dropGeneral roundOne grayBg">
              <select name="guiest_id15" id="guiest_id15" class="select-drop">
                <option value="0">Dropdown 2</option>
                <option value="1">Dropdown 2a</option>
                <option value="2">Dropdown 2b</option>
                <option value="3">Dropdown 2c</option>            
            ...
            <div class="dropGeneral roundOne border-color-2">
              <select name="guiest_id16" id="guiest_id16" class="select-drop">
                <option value="0">Dropdown 2</option>
                <option value="1">Dropdown 2a</option>
                <option value="2">Dropdown 2b</option>
                <option value="3">Dropdown 2c</option>            
            ...
            <div class="dropGeneral roundOne">
              <select name="guiest_id17" id="guiest_id17" class="select-drop">
                <option value="0">Dropdown 2</option>
                <option value="1">Dropdown 2a</option>
                <option value="2">Dropdown 2b</option>
                <option value="3">Dropdown 2c</option>            
          ...
          <div class="col-sm-3 col-xs-12">
            <div class="dropGeneral roundTwo colorBg bg-color-6">
              <select name="guiest_id18" id="guiest_id18" class="select-drop">
                <option value="0">Dropdown 3</option>
                <option value="1">Dropdown 3a</option>
                <option value="2">Dropdown 3b</option>
                <option value="3">Dropdown 3c</option>            
              </select>
            </div>
            <div class="dropGeneral roundTwo grayBg">
            ...
            <div class="dropGeneral roundTwo border-color-6">
              <select name="guiest_id20" id="guiest_id20" class="select-drop">
                <option value="0">Dropdown 3</option>
                <option value="1">Dropdown 3a</option>
                <option value="2">Dropdown 3b</option>
                <option value="3">Dropdown 3c</option>            
            ...
            <div class="dropGeneral roundTwo">
              <select name="guiest_id21" id="guiest_id21" class="select-drop">
                <option value="0">Dropdown 3</option>
                <option value="1">Dropdown 3a</option>
                <option value="2">Dropdown 3b</option>
                <option value="3">Dropdown 3c</option>            
          ...
          <div class="col-sm-3 col-xs-12">
            <div class="dropGeneral roundThree colorBg bg-color-5">
              <select name="guiest_id22" id="guiest_id22" class="select-drop">
                <option value="0">Dropdown 4</option>
                <option value="1">Dropdown 4a</option>
                <option value="2">Dropdown 4b</option>
                <option value="3">Dropdown 4c</option>            
              </select>
            </div>
            <div class="dropGeneral roundThree grayBg">
              <select name="guiest_id23" id="guiest_id23" class="select-drop">
                <option value="0">Dropdown 4</option>
                <option value="1">Dropdown 4a</option>
                <option value="2">Dropdown 4b</option>
                <option value="3">Dropdown 4c</option>            
            ...
            <div class="dropGeneral roundThree border-color-5">
              <select name="guiest_id24" id="guiest_id24" class="select-drop">
                <option value="0">Dropdown 4</option>
                <option value="1">Dropdown 4a</option>
                <option value="2">Dropdown 4b</option>
                <option value="3">Dropdown 4c</option>            
            ...
            <div class="dropGeneral roundThree">
              <select name="guiest_id25" id="guiest_id25" class="select-drop">
                <option value="0">Dropdown 4</option>
                <option value="1">Dropdown 4a</option>
                <option value="2">Dropdown 4b</option>
                <option value="3">Dropdown 4c</option>            
