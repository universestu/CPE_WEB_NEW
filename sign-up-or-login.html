...
<head>
  ...
  <title>Sign Up or Login - KIDZ</title>
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li class="active dropdown singleDrop color-3">
                ...
                <ul class="dropdown-menu dropdown-menu-left">
                  ...
                  <li class="active"><a href="sign-up-or-login.html">Sign Up / Login</a></li>
      ...
      <div class="container">
       <div class="pageTitleInfo">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Sign up or Log in</li>
          </ol>
        </div>
      </div>
    </section>
    ...
    <footer>
      ...
      <div class="container-fluid color-bar clearfix">
        <div class="row">
          ...
          <div class="col-sm-1 bg-color-4 hidden-xs">fix bar</div>
          <div class="col-sm-1 bg-color-5 hidden-xs">fix bar</div>
          <div class="col-sm-1 bg-color-6 hidden-xs">fix bar</div>e
        </div>
      </div>
      <!-- FOOTER INFO AREA -->
